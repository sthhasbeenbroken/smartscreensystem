<template>
    <div>
        ...
        <div class="add">
             <el-button type="primary" @click="dialogVisible = true">创建公告</el-button>
        ...
        <div class="main">
            ...
            ><el-table-column type="selection" width="40"/>
              <el-table-column property="name" label="公告内容" width="400" />
              <el-table-column property="address" label="播放时间"  width="180"/>
              <el-table-column property="state"   label="公告状态"  width="140"/>
              <el-table-column property="address" label="作者"  width="140"/>
              <el-table-column property="address" label="创建时间"  width="160"/>
                ...
                <template #default>
                    ...
                    <el-button link type="primary"  @click="handleClick">编辑</el-button>
                     <el-button link type="primary" >复制</el-button>
                      <el-button link type="primary" disabled>下线</el-button>
